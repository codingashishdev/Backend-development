...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, videoData, "your video is ready to be watched")
        );
});
...
const updateVideo = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, {}, "video updatded successfully"));
});
...
const togglePublishStatus = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, {}, "Published status changed"));
});
