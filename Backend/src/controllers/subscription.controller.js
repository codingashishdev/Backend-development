...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
    ...
    if (!channelSubscribers) {
        throw new ApiError(400, "Errow while fetching channel subscribers")
    }
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, channelsSubscribedByUser, "User subscribed channels fetched successfully")
        )
})
